...
cd $DPMI
mkdir p0f argus pulledpork BroIDS jquery-sparklines nsm-console eventlog TreeMap Cytoscape Mondrian TNV Parvis Timesearcher1 walrus PerlPackages GUESS NVisionIP InetVis processing PyInline Rumint gltail Rstudio RPackages FlowTag tcpdump INAV Netgrok SeedsOfContempt Shoki RTGraph3D 
...
## TODO Cannot locate download for Shoki
